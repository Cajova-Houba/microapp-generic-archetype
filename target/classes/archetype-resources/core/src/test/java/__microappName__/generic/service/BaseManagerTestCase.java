package ${groupId}.${microappName}.generic.service;
...
/**
 * Test classes can extend this manager based on a spring context. This test
 * class can be moved to the test tree.
 *
 * @author mraible
 */
